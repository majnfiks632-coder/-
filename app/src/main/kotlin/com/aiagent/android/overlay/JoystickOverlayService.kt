...
class JoystickOverlayService : Service() {
    ...
    companion object {
        ...
        /**
         * Floating-joystick gate. The joystick is a device-control overlay (AI uses it to drag
         * sticks in games), so we only show it when «Управлять телефоном» is on AND the user
         * is not currently inside the chat. Matches the rule used by [OverlayService].
         */
