            ...
            KiroTheme {
                Surface(
                    ...
                    ChatScreen(
                        viewModel = viewModel,
                        onMicClick = {
                            // Voice dictation: the user taps the mic button on the input
                            // bar. Ensure RECORD_AUDIO is granted, then ask the ViewModel
                            // to start (or stop, if already listening) on-device STT.
