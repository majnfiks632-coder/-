...
; Строки печатаются через BIOS Teletype (CP437) и COM1 одновременно.
; CP437 не содержит кириллицы, поэтому здесь используется транслитерация
; русских слов латиницей, чтобы все сообщения были русскоязычными (пусть и
; латиницей). После перехода в ядро включается наш собственный шрифт
; «Дубина 8×16» и весь вывод идёт нормальной кириллицей.
msg_mbr:       db "DubinaOS Stage1: zagruzka Stage2...", 13, 10, 0
msg_jump:      db "Stage1: Stage2 zagruzhen, perehod...", 13, 10, 0
msg_error:     db "Stage1: oshibka chteniya diska!", 13, 10, 0
